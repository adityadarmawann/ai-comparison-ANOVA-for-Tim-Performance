...
.stSidebar {{ background:#f1f3f5 !important; border-right:1px solid {C['border']}; }}
...
def load_hr(uploaded_file):
    ...
    if missing:
        st.error(f"❌ Kolom yang hilang di file HR: {missing}")
...
def page_distribusi():
    ...
    # --- Mean profile plot ---
    st.markdown("<br>", unsafe_allow_html=True); st.markdown(sh("Rata-rata Skor","Profile Plot"), unsafe_allow_html=True)
    ...
    # --- Deskriptif tabel ---
    st.markdown("<br>", unsafe_allow_html=True); st.markdown(sh("Statistik Deskriptif","Tabel"), unsafe_allow_html=True)
    rows = []
...
def page_anova():
    ...
    # ANOVA cards
    st.markdown("<br>", unsafe_allow_html=True); st.markdown(sh("Hasil RM-ANOVA","Omnibus F-test"), unsafe_allow_html=True)
    cols = st.columns(3)
    ...
    # Post-hoc heatmap
    st.markdown("<br>", unsafe_allow_html=True); st.markdown(sh("Post-Hoc Heatmap","Hedges d · Bonferroni"), unsafe_allow_html=True)
...
def page_akurasi():
    ...
    # Pearson grouped bar
    st.markdown("<br>", unsafe_allow_html=True); st.markdown(sh("Korelasi Pearson vs HR","Per Variabel"), unsafe_allow_html=True)
    ...
    # Full table
    st.markdown("<br>", unsafe_allow_html=True); st.markdown(sh("Tabel Akurasi Lengkap","Detail"), unsafe_allow_html=True)
...
def page_ranking():
    ...
    st.markdown("<br>", unsafe_allow_html=True); st.markdown(sh("Tabel Ranking Detail","Semua Metrik"), unsafe_allow_html=True)
...
def page_validitas():
    ...
    st.markdown("<br>", unsafe_allow_html=True); st.markdown(sh("Korelasi Spearman","Validitas Eksternal"), unsafe_allow_html=True)
    ...
    st.markdown("<br>", unsafe_allow_html=True); st.markdown(sh("Tabel Korelasi Lengkap","Pearson & Spearman"), unsafe_allow_html=True)
    disp = df_corr.copy()
